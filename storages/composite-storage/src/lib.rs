...
use {
    wql_core::{
        data::Schema,
        error::{Error, Result},
        store::{GStore, Metadata, Store},
    },
    std::collections::HashMap,
};

pub trait IStorage: GStore {}

impl<T: GStore> IStorage for T {}
...
impl wql_core::store::Index for CompositeStorage {}
impl wql_core::store::IndexMut for CompositeStorage {}
impl Metadata for CompositeStorage {}
impl wql_core::store::CustomFunction for CompositeStorage {}
impl wql_core::store::CustomFunctionMut for CompositeStorage {}
