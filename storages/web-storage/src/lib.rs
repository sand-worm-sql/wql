...
/// wql-schema-names -> {Vec<String>}
const TABLE_NAMES_PATH: &str = "wql-schema-names";

/// wql-schema/{schema_name} -> {Schema}
const SCHEMA_PATH: &str = "wql-schema";

/// wql-data/{table_name} -> {Vec<DataRow>}
const DATA_PATH: &str = "wql-data";
